...
class Polynomial:
    ...
    def multiply(self, s_poly_obj):
        if (self is not None) and (s_poly_obj is not None):
            ...
            raise TypeError('Please, introduce a valid polynomial to be multiplied.')
...
poly1 = Polynomial([None, Term(2, 3)])
poly2 = Polynomial([Term(2, 3), Term(2, 3)])
